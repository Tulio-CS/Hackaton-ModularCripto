...
function App() {
  ...
  const [contractInfo, setContractInfo] = useState<{version: string, network: string} | null>(null);

  const handleWalletConnect = async (address: string) => {
    setWalletAddress(address);
    
    try {
      // Get contract info after connecting
      const info = await arbitrumService.getContractInfo();
      ...
      <main className="container mx-auto px-4 py-12">
        <section className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
            A transparent, secure, and fair betting platform powered by Arbitrum blockchain technology.
            Create bets, place wagers, and claim winnings with low fees and fast transactions.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button 
              ...
              onClick={() => walletAddress ? window.location.href = '#create-bet' : alert('Please connect your wallet first')}
            >
              Start Betting
            </button>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
              ...
              <p className="text-gray-300">
                All bets are recorded on the Arbitrum blockchain, ensuring complete transparency and fairness with lower gas fees.
              </p>
            </div>
            <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
              <div className="bg-yellow-500/20 p-3 rounded-full w-fit mb-4">
              ...
              <p className="text-gray-300">
                Claim your winnings instantly once a bet is resolved, with faster confirmations on Arbitrum's Layer 2 network.
              </p>
            </div>
            <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
              <div className="bg-yellow-500/20 p-3 rounded-full w-fit mb-4">
              ...
              <p className="text-gray-300">
                Create your own betting markets with custom outcomes and timeframes, all with minimal transaction costs.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="how-it-works" className="mb-20">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">Connect your Ethereum wallet to the Arbitrum network to interact with the platform.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">Create your own betting markets or participate in existing ones on Arbitrum.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">Choose your outcome and place your bet with ETH on Arbitrum's fast Layer 2 network.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">After the bet is resolved, winners can claim their rewards instantly with low fees.</p>
            </div>
          </div>
        </section>
        ...
        <section id="contract" className="mb-20">
          ...
          <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
            <div className="flex items-start mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">ArbitrumBettingEcosystem Contract</h3>
                <p className="text-gray-300 mb-4">
                  Our platform is powered by a secure, optimized smart contract deployed on the Arbitrum network for lower fees and faster transactions.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              {contractInfo && (
                <span className="text-xs text-gray-400">v{contractInfo.version} on {contractInfo.network}</span>
              )}
            </div>
